...
public class CoverTest {
	...
	Cube cube2 = new Cube(new ThreeStateValue[] {ThreeStateValue.zero, ThreeStateValue.one, ThreeStateValue.zero}, ThreeStateValue.one);
	Cube cube3 = new Cube(new ThreeStateValue[] {ThreeStateValue.zero, ThreeStateValue.one, ThreeStateValue.one}, ThreeStateValue.dontCare);
	Cube cube4 = new Cube(new ThreeStateValue[] {ThreeStateValue.one, ThreeStateValue.zero, ThreeStateValue.zero}, ThreeStateValue.one);
